    ...
    <div class="container py-5">
        ...
        <div class="row g-5 mb-5">
            ...
            <div class="col-lg-4">
                <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.4s">
                    ...
                    <div class="ps-4">
                        <h5 class="mb-2">Correo electrónico para consultas</h5>
                        <h6 class="text-primary mb-0">techologies@geotekhperu.com</h6>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.8s">
                    ...
                    <div class="ps-4">
                        ...
                        <h6 class="text-primary mb-0">Clodomiro Cerna #360, Cajamarca, Perú</h6>
                    </div>
                </div>
            </div>
        </div>
        <div class="row g-5">
            ...
            <div class="col-lg-6 wow slideInUp" data-wow-delay="0.6s">
                <iframe class="position-relative rounded w-100 h-100" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15834.711642878076!2d-78.4989736!3d-7.163184!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x91b25bf905298bd1%3A0x2256d97aea37b1f7!2sGEOTEKH%20PER%C3%9A!5e0!3m2!1ses!2spe!4v1686762641334!5m2!1ses!2spe" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" frameborder="0" style="min-height: 350px; border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
            </div>
        </div>
    </div>
</div>
