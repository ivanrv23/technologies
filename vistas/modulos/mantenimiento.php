<div class="container-fluid bg-primary py-5 bg-header-sistema-trujillo" style="margin-bottom: 90px;">
    <div class="row py-5">
        <div class="col-12 pt-lg-5 mt-lg-5 text-center">
            <h1 class="display-1 text-white animated zoomIn">SISTEMA TRUJILLO</h1>
        </div>
    </div>
</div>
</div>
...
<div class="container-fluid wow fadeInUp" data-wow-delay="0.1s">
    <div class="container">
        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.6s">
            ...
            <img class="img-fluid rounded" src="vistas/img/sistema-trujillo/sistema-trujillo-1.jpg" alt="">
            </div>
            <div class="testimonial-item bg-light my-4">
            <img class="img-fluid rounded" src="vistas/img/sistema-trujillo/sistema-trujillo-1.jpg" alt="">
            </div>
            <div class="testimonial-item bg-light my-4">
            <img class="img-fluid rounded" src="vistas/img/sistema-trujillo/sistema-trujillo-1.jpgg" alt="">
            </div>
            <div class="testimonial-item bg-light my-4">
            <img class="img-fluid rounded" src="vistas/img/sistema-trujillo/sistema-trujillo-1.jpg" alt="">
            </div>
