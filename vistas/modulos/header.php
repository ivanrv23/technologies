        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>Clodomiro Cerna #360, Cajamarca - Perú</small>
                    <small class="me-3 text-light"><i class="fa fa-phone-alt me-2"></i>+51 997 226 188</small>
                    <small class="text-light"><i class="fa fa-envelope-open me-2"></i>technologies.geotekhperu.com</small>
                </div>
            </div>
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            <a href="index.html" class="navbar-brand p-0">
                ...
                <img class="img-fluid rounded" src="vistas/img/logo-technologies-n.png">
            </a>
