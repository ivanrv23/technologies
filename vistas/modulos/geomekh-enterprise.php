<!-- <div class="container-fluid bg-primary py-5 bg-header-geomekh" style="margin-bottom: 90px;">
    <div class="row py-5">
        <div class="col-12 pt-lg-5 mt-lg-5 text-center">
            <h1 class="display-1 text-white animated zoomIn">GEOMEKH ENTERPRISE</h1>
        </div>
    </div>
</div>
</div> -->
        ...
        <div class="row g-5">
            <div class="col-lg-7">
                <div class="section-title position-relative pb-3 mb-5">
                    ...
                    <h1 class="mb-0">Llegó el software para que tu empresa mapeo de manera profesional</h1>
                </div>
                <p class="mb-4">Lleva el mapeo a otro nivel desde tu escritorio hasta con tu celular.</p>
            ...
            <div class="col-lg-5" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="vistas/img/geomekh2/geomekh2-1.jpg" style="object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
...
<!-- <div class="container-fluid wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
            ...
            <h1 class="mb-0">Ofrecemos los mejores planes de acuerdo a nuestros clientes</h1>
        </div>
        <div class="row g-0">
            <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                <div class="bg-light rounded">
                    <div class="border-bottom py-4 px-5 mb-4">
                        ...
                        <small class="text-uppercase">Ideal para público en general</small>
                    </div>
                    <div class="p-5 pt-0">
            ...
            <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                <div class="bg-white rounded shadow position-relative" style="z-index: 1;">
                    <div class="border-bottom py-4 px-5 mb-4">
                        ...
                        <small class="text-uppercase">Ideal para estudiantes</small>
                    </div>
                    <div class="p-5 pt-0">
                        <h1 class="display-5 mb-3">
            ...
            <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                <div class="bg-light rounded">
                    <div class="border-bottom py-4 px-5 mb-4">
                        ...
                        <small class="text-uppercase">Para empresas y/o instituciones</small>
                    </div>
                    <div class="p-5 pt-0">
                        <h1 class="display-5 mb-3">
...
<div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
        <div class="row py-5">
            <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                <h1 class="display-4 text-white animated zoomIn">ASESORÍAS</h1>
                <a href="inicio" class="h5 text-white">Ir a inicio</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="contacto" class="h5 text-white">Ir a contacto</a>
            </div>
        </div>
    </div>
</div>
