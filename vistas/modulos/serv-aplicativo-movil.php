        ...
        <div class="row g-5">
            <div class="col-lg-7">
                <div class="section-title position-relative pb-2 mb-2">
                    <h5 class="fw-bold text-primary text-uppercase">DESARROLLO DE APLICACIONES MÓVILES</h5>
                </div>
                <p style="text-align: justify;">El equipo de Geotekh te ofrece las mejores tecnologías
                    para el desarrollo de aplicaciones móviles a medida, seguras y escalables.
                ...
                <a href="vistas/img/pdfs/ServicioAplicacionesMoviles.pdf" class="btn btn-primary py-3 px-5 mt-3 wow zoomIn" data-wow-delay="0.9s">Brochure</a>

            </div>
            <div class="col-lg-5" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-99 rounded wow zoomIn" data-wow-delay="0.4s" src="vistas/img/imagenes/img-app-mobiles.png" style="object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
